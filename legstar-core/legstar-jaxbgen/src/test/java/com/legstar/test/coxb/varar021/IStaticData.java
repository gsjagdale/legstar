...
/**
 * <p>Java class for IStaticData complex type</p>.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="LkupInfo" type="{http://legstar.com/test/coxb/varar021}LkupInfo39" maxOccurs="2" minOccurs="2"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable
{
    ...
    @CobolElement(cobolName = "LKUP-INFO", type = CobolType.GROUP_ITEM, levelNumber = 10, minOccurs = 2, maxOccurs = 2, srceLine = 39)
