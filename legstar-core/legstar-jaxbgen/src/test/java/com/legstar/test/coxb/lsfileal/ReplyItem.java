 ...
 *           &lt;/simpleType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="ReplyPersonal" type="{http://legstar.com/test/coxb/lsfileal}ReplyPersonal"/&gt;
    ...
    implements Serializable
{
    ...
    @CobolElement(cobolName = "REPLY-NUMBER", type = CobolType.ZONED_DECIMAL_ITEM, levelNumber = 15, isSigned = false, totalDigits = 6, picture = "9(6)", srceLine = 69)
    protected long replyNumber;
    @XmlElement(name = "ReplyPersonal", required = true)
    @CobolElement(cobolName = "REPLY-PERSONAL", type = CobolType.GROUP_ITEM, levelNumber = 15, srceLine = 70)
    protected ReplyPersonal replyPersonal;
    @XmlElement(name = "ReplyDate", required = true)
    @CobolElement(cobolName = "REPLY-DATE", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 15, picture = "X(8)", srceLine = 74)
    protected String replyDate;
    @XmlElement(name = "ReplyAmount", required = true)
    @CobolElement(cobolName = "REPLY-AMOUNT", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 15, picture = "X(8)", srceLine = 75)
    protected String replyAmount;
    @XmlElement(name = "ReplyComment", required = true)
    @CobolElement(cobolName = "REPLY-COMMENT", type = CobolType.ALPHANUMERIC_ITEM, levelNumber = 15, picture = "X(9)", srceLine = 76)
